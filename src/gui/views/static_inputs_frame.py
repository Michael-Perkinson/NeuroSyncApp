...
class StaticInputsFrame(ttk.Frame):
    def __init__(self, parent, width=None, save_inputs_callback=None, **kwargs):
        ...
        bind_tk_var(self.pre_behaviour_time_var, self.view_state, "pre_behaviour_time")
        bind_tk_var(self.post_behaviour_time_var, self.view_state, "post_behaviour_time")
        bind_tk_var(self.bin_size_var, self.view_state, "bin_size")
    ...
    def create_frame_widgets(self):
        ...
        bind_tk_var(self.selected_behaviour, self.view_state, "selected_behaviour")
