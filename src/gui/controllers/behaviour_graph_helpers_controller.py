...
class BehaviourGraphHelpersController:
    ...
    def add_transparent_boxes(
        ...
        if self.app.checkbox_state:
            time_data = self.app.dataframe.get(
                "z_scored_time", self.app.behaviour_data_controller.calculate_z_score()[1]
            ).copy()
        else:
    ...
    def refresh_graph(self) -> None:
        self.app.ax.clear()
        self.app.plot_controller.plot_full_trace(self.app.ax)
