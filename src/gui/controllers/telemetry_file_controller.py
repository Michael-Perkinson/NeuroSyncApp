...
class TelemetryFileController:
    ...
    def common_setup(self, file_path_var, dataframe, mouse_name) -> None:
        ...
        self.app.telemetry_table_controller.clear_table()
    ...
    def process_photometry_data_file(self) -> None:
        ...
        self.app.telemetry_plot_controller.precalculate_data_versions()
        ...
        (
            ...
            clusters_final,
            grouped_clusters,
        ) = self.app.telemetry_plot_controller.get_current_photometry_data()
    ...
    def handle_opto_data_file(self) -> None:
        ...
        self.app.stim_timings = self.app.telemetry_plot_controller.calculate_stim_timings(
            stim_data_df
        )
        ...
        self.app.telemetry_plot_controller.overlay_temp_and_act()
