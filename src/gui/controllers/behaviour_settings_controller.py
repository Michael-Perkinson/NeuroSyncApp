...
class BehaviourSettingsController:
    ...
    def save_inputs(self) -> None:
        ...
        self.app.behaviour_table_controller.update_table(current_df, new=True)
        save_behaviour_static_inputs(current_df, "behaviour_settings.json")
