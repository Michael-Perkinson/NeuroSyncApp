...
class BehaviourManualController:
    ...
    def parse_manual_data(self, file_path: str) -> None:
        try:
            ...
            behaviour_settings = load_behaviour_static_inputs("behaviour_settings.json")
            self.app.behaviour_table_controller.clear_table()
    ...
    def calculate_and_store_behavior_metrics(self, behavior_durations) -> None:
        for behavior, times in behavior_durations.items():
            ...
            self.app.duration_data_cache[behavior] = {
                "mean_duration": self.app.behaviour_graph_helpers_controller.convert_and_retrieve_time(
                    mean_duration
                ),
                "sem_duration": self.app.behaviour_graph_helpers_controller.convert_and_retrieve_time(
                    sem_duration
                ),
                "mean_sem_df": None,
    ...
    def update_behaviour_dropdowns(self, behaviour_names, table_data) -> None:
        ...
        if single_instance_behaviours:
            ...
            self.app.graph_settings_container_instance.selected_behaviour_to_zero.trace_add(
                "write", self.app.behaviour_graph_helpers_controller.handle_behaviour_change
            )
    ...
    def on_row_click(self, event) -> None:
        ...
        self.app.plot_controller.handle_figure_display_selection(event=None)
