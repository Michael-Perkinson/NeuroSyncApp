...
class BehaviourOptionsPanel:
    ...
    def create_control_buttons(self) -> None:
        ...
        select_all_button.clicked.connect(self.app.static_inputs_service.select_all)
        ...
        deselect_all_button.clicked.connect(
            self.app.static_inputs_service.deselect_all
        )
    ...
    def create_checkbox(self, behaviour, row_layout, parent) -> None:
        ...
        behaviour_option_checkbox.clicked.connect(
            self.app.static_inputs_service.refresh_behaviour_options
        )
